...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.DownloadXSDApi = factory(root.Authentication.MLEUtility, root.CyberSource.ApiClient);
  }
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.getXSDV2 = function(reportDefinitionNameVersion, callback) {
      ...
      //check isMLE for an api method 'this.getXSDV2'
      var isMLESupportedByCybsForApi = false;
      var isMLEForApi = MLEUtility.checkIsMLEForAPI(this.apiClient.merchantConfig, isMLESupportedByCybsForApi, 'getXSDV2');

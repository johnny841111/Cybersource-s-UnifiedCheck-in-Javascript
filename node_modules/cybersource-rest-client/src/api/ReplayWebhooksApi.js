...
(function(root, factory) {
  ...
  var exports = function(configObject, apiClient) {
    ...
    this.replayPreviousWebhooks = function(webhookId, opts, callback) {
      ...
      postBody = sdkTracker.insertDeveloperIdTracker(postBody, 'module:model/ReplayWebhooksRequest', this.apiClient.merchantConfig.runEnvironment, this.apiClient.merchantConfig.defaultDeveloperId);

...
(function(root, factory) {
  ...
  /**
   * The CommerceSolutionsProductsAccountUpdaterConfigurationInformation model module.
   * @module model/CommerceSolutionsProductsAccountUpdaterConfigurationInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>CommerceSolutionsProductsAccountUpdaterConfigurationInformation</code>.
   * @alias module:model/CommerceSolutionsProductsAccountUpdaterConfigurationInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>CommerceSolutionsProductsAccountUpdaterConfigurationInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CommerceSolutionsProductsAccountUpdaterConfigurationInformation} obj Optional instance to populate.
   * @return {module:model/CommerceSolutionsProductsAccountUpdaterConfigurationInformation} The populated <code>CommerceSolutionsProductsAccountUpdaterConfigurationInformation</code> instance.
   */

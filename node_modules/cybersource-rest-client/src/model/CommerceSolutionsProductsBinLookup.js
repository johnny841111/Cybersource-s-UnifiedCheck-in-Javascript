...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CommerceSolutionsProductsBinLookupConfigurationInformation', 'model/PaymentsProductsPayerAuthenticationSubscriptionInformation'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CommerceSolutionsProductsBinLookupConfigurationInformation'), require('./PaymentsProductsPayerAuthenticationSubscriptionInformation'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.CommerceSolutionsProductsBinLookup = factory(root.CyberSource.ApiClient, root.CyberSource.CommerceSolutionsProductsBinLookupConfigurationInformation, root.CyberSource.PaymentsProductsPayerAuthenticationSubscriptionInformation);
  }
}(this, function(ApiClient, CommerceSolutionsProductsBinLookupConfigurationInformation, PaymentsProductsPayerAuthenticationSubscriptionInformation) {
  'use strict';

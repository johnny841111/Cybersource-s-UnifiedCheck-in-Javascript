...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('senderInformation')) {
        obj['senderInformation'] = Ptsv2paymentsSenderInformation.constructFromObject(data['senderInformation']);
      }
      ...
      if (data.hasOwnProperty('unscheduledPaymentInformation')) {
        obj['unscheduledPaymentInformation'] = Ptsv2paymentsUnscheduledPaymentInformation.constructFromObject(data['unscheduledPaymentInformation']);
      }
      if (data.hasOwnProperty('hostedPaymentInformation')) {
        obj['hostedPaymentInformation'] = Ptsv2paymentsHostedPaymentInformation.constructFromObject(data['hostedPaymentInformation']);
      }
  ...
  /**
   * @member {module:model/Ptsv2paymentsSenderInformation} senderInformation
   */
  ...
  /**
   * @member {module:model/Ptsv2paymentsUnscheduledPaymentInformation} unscheduledPaymentInformation
   */
  exports.prototype['unscheduledPaymentInformation'] = undefined;
  /**
   * @member {module:model/Ptsv2paymentsHostedPaymentInformation} hostedPaymentInformation
   */
  exports.prototype['hostedPaymentInformation'] = undefined;
  /**

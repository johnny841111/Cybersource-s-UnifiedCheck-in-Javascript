...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.GetAllPlansResponseLinks = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsPost201ResponseLinksSelf);
  }
  ...
  /**
   * The GetAllPlansResponseLinks model module.
   * @module model/GetAllPlansResponseLinks
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>GetAllPlansResponseLinks</code>.
   * @alias module:model/GetAllPlansResponseLinks
   * @class
   */
  ...
  /**
   * Constructs a <code>GetAllPlansResponseLinks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAllPlansResponseLinks} obj Optional instance to populate.
   * @return {module:model/GetAllPlansResponseLinks} The populated <code>GetAllPlansResponseLinks</code> instance.
   */

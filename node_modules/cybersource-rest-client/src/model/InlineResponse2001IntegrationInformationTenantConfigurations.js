...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.InlineResponse2001IntegrationInformationTenantConfigurations = factory(root.CyberSource.ApiClient, root.CyberSource.Boardingv1registrationsIntegrationInformationTenantInformation);
  }
  ...
  /**
   * The InlineResponse2001IntegrationInformationTenantConfigurations model module.
   * @module model/InlineResponse2001IntegrationInformationTenantConfigurations
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>InlineResponse2001IntegrationInformationTenantConfigurations</code>.
   * @alias module:model/InlineResponse2001IntegrationInformationTenantConfigurations
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2001IntegrationInformationTenantConfigurations</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2001IntegrationInformationTenantConfigurations} obj Optional instance to populate.
   * @return {module:model/InlineResponse2001IntegrationInformationTenantConfigurations} The populated <code>InlineResponse2001IntegrationInformationTenantConfigurations</code> instance.
   */

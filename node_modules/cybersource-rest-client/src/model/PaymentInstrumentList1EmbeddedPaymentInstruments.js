...
(function(root, factory) {
  ...
  /**
   * The PaymentInstrumentList1EmbeddedPaymentInstruments model module.
   * @module model/PaymentInstrumentList1EmbeddedPaymentInstruments
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentInstrumentList1EmbeddedPaymentInstruments</code>.
   * @alias module:model/PaymentInstrumentList1EmbeddedPaymentInstruments
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentInstrumentList1EmbeddedPaymentInstruments</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentInstrumentList1EmbeddedPaymentInstruments} obj Optional instance to populate.
   * @return {module:model/PaymentInstrumentList1EmbeddedPaymentInstruments} The populated <code>PaymentInstrumentList1EmbeddedPaymentInstruments</code> instance.
   */
  ...
  /**
   * @member {module:model/PaymentInstrumentList1EmbeddedEmbedded} _embedded
   */

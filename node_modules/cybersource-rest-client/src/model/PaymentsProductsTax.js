...
(function(root, factory) {
  ...
  /**
   * The PaymentsProductsTax model module.
   * @module model/PaymentsProductsTax
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>PaymentsProductsTax</code>.
   * @alias module:model/PaymentsProductsTax
   * @class
   */
  ...
  /**
   * Constructs a <code>PaymentsProductsTax</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PaymentsProductsTax} obj Optional instance to populate.
   * @return {module:model/PaymentsProductsTax} The populated <code>PaymentsProductsTax</code> instance.
   */

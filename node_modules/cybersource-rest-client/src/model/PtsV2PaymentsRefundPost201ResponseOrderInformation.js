...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PtsV2PaymentsCapturesPost201ResponseOrderInformationInvoiceDetails', 'model/PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PtsV2PaymentsCapturesPost201ResponseOrderInformationInvoiceDetails'), require('./PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.PtsV2PaymentsRefundPost201ResponseOrderInformation = factory(root.CyberSource.ApiClient, root.CyberSource.PtsV2PaymentsCapturesPost201ResponseOrderInformationInvoiceDetails, root.CyberSource.PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails);
  }
}(this, function(ApiClient, PtsV2PaymentsCapturesPost201ResponseOrderInformationInvoiceDetails, PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amountDetails')) {
        obj['amountDetails'] = PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails.constructFromObject(data['amountDetails']);
      }
  ...
  /**
   * @member {module:model/PtsV2PaymentsRefundPost201ResponseOrderInformationAmountDetails} amountDetails
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2billingagreementsClientReferenceInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2paymentsClientReferenceInformationPartner);
  }
  ...
  /**
   * The Ptsv2billingagreementsClientReferenceInformation model module.
   * @module model/Ptsv2billingagreementsClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2billingagreementsClientReferenceInformation</code>.
   * @alias module:model/Ptsv2billingagreementsClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2billingagreementsClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2billingagreementsClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2billingagreementsClientReferenceInformation} The populated <code>Ptsv2billingagreementsClientReferenceInformation</code> instance.
   */

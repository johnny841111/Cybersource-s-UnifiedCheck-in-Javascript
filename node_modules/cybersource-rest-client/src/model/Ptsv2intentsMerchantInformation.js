...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2intentsMerchantInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2intentsMerchantInformationMerchantDescriptor);
  }
  ...
  /**
   * The Ptsv2intentsMerchantInformation model module.
   * @module model/Ptsv2intentsMerchantInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2intentsMerchantInformation</code>.
   * @alias module:model/Ptsv2intentsMerchantInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2intentsMerchantInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2intentsMerchantInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2intentsMerchantInformation} The populated <code>Ptsv2intentsMerchantInformation</code> instance.
   */

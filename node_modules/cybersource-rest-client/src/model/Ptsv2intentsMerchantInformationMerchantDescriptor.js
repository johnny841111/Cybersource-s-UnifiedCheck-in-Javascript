...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2intentsMerchantInformationMerchantDescriptor = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv2intentsMerchantInformationMerchantDescriptor model module.
   * @module model/Ptsv2intentsMerchantInformationMerchantDescriptor
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2intentsMerchantInformationMerchantDescriptor</code>.
   * @alias module:model/Ptsv2intentsMerchantInformationMerchantDescriptor
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2intentsMerchantInformationMerchantDescriptor</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2intentsMerchantInformationMerchantDescriptor} obj Optional instance to populate.
   * @return {module:model/Ptsv2intentsMerchantInformationMerchantDescriptor} The populated <code>Ptsv2intentsMerchantInformationMerchantDescriptor</code> instance.
   */

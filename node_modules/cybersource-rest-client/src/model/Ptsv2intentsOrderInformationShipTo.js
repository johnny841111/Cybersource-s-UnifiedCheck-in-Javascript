...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2intentsOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv2intentsOrderInformationShipTo model module.
   * @module model/Ptsv2intentsOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2intentsOrderInformationShipTo</code>.
   * @alias module:model/Ptsv2intentsOrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2intentsOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2intentsOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Ptsv2intentsOrderInformationShipTo} The populated <code>Ptsv2intentsOrderInformationShipTo</code> instance.
   */

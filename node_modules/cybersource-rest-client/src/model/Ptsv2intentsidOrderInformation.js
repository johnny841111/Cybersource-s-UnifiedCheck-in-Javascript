...
(function(root, factory) {
  ...
  /**
   * The Ptsv2intentsidOrderInformation model module.
   * @module model/Ptsv2intentsidOrderInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2intentsidOrderInformation</code>.
   * @alias module:model/Ptsv2intentsidOrderInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2intentsidOrderInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2intentsidOrderInformation} obj Optional instance to populate.
   * @return {module:model/Ptsv2intentsidOrderInformation} The populated <code>Ptsv2intentsidOrderInformation</code> instance.
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Ptsv2paymentreferencesOrderInformationShipTo = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Ptsv2paymentreferencesOrderInformationShipTo model module.
   * @module model/Ptsv2paymentreferencesOrderInformationShipTo
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Ptsv2paymentreferencesOrderInformationShipTo</code>.
   * @alias module:model/Ptsv2paymentreferencesOrderInformationShipTo
   * @class
   */
  ...
  /**
   * Constructs a <code>Ptsv2paymentreferencesOrderInformationShipTo</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ptsv2paymentreferencesOrderInformationShipTo} obj Optional instance to populate.
   * @return {module:model/Ptsv2paymentreferencesOrderInformationShipTo} The populated <code>Ptsv2paymentreferencesOrderInformationShipTo</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('notApplicable')) {
        obj['notApplicable'] = ApiClient.convertToType(data['notApplicable'], 'String');
      }
   ...
   * @member {String} notApplicable
   */
  exports.prototype['notApplicable'] = undefined;
  /**

...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('authenticationBrand')) {
        obj['authenticationBrand'] = ApiClient.convertToType(data['authenticationBrand'], 'String');
      }
   ...
   * @member {String} authenticationBrand
   */
  exports.prototype['authenticationBrand'] = undefined;
  /**

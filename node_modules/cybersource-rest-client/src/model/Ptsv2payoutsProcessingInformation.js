...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Ptsv2payoutsProcessingInformationFundingOptions', 'model/Ptsv2payoutsProcessingInformationPayoutsOptions', 'model/Ptsv2payoutsProcessingInformationPurchaseOptions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Ptsv2payoutsProcessingInformationFundingOptions'), require('./Ptsv2payoutsProcessingInformationPayoutsOptions'), require('./Ptsv2payoutsProcessingInformationPurchaseOptions'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.Ptsv2payoutsProcessingInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Ptsv2payoutsProcessingInformationFundingOptions, root.CyberSource.Ptsv2payoutsProcessingInformationPayoutsOptions, root.CyberSource.Ptsv2payoutsProcessingInformationPurchaseOptions);
  }
}(this, function(ApiClient, Ptsv2payoutsProcessingInformationFundingOptions, Ptsv2payoutsProcessingInformationPayoutsOptions, Ptsv2payoutsProcessingInformationPurchaseOptions) {
  'use strict';

...
(function(root, factory) {
   ...
   * @class
   * @param authenticationTransactionId {String} Payer authentication transaction identifier passed to link the check enrollment and validate authentication messages.For Rupay,this is passed only in Re-Send OTP usecase. **Note**: Required for Standard integration, Rupay Seamless server to server integration for enroll service. Required for Hybrid integration for validate service. 
   */
  var exports = function(authenticationTransactionId) {
    var _this = this;

    _this['authenticationTransactionId'] = authenticationTransactionId;

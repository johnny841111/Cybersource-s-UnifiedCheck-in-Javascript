...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsPaymentInformationCustomer = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1authenticationsPaymentInformationCustomer model module.
   * @module model/Riskv1authenticationsPaymentInformationCustomer
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationsPaymentInformationCustomer</code>.
  ...
  /**
   * Constructs a <code>Riskv1authenticationsPaymentInformationCustomer</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationsPaymentInformationCustomer} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationsPaymentInformationCustomer} The populated <code>Riskv1authenticationsPaymentInformationCustomer</code> instance.
   */

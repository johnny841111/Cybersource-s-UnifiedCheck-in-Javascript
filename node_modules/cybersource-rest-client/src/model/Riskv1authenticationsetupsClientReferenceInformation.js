...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1authenticationsetupsClientReferenceInformation = factory(root.CyberSource.ApiClient, root.CyberSource.Riskv1decisionsClientReferenceInformationPartner);
  }
  ...
  /**
   * The Riskv1authenticationsetupsClientReferenceInformation model module.
   * @module model/Riskv1authenticationsetupsClientReferenceInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1authenticationsetupsClientReferenceInformation</code>.
   * @alias module:model/Riskv1authenticationsetupsClientReferenceInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1authenticationsetupsClientReferenceInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1authenticationsetupsClientReferenceInformation} obj Optional instance to populate.
   * @return {module:model/Riskv1authenticationsetupsClientReferenceInformation} The populated <code>Riskv1authenticationsetupsClientReferenceInformation</code> instance.
   */

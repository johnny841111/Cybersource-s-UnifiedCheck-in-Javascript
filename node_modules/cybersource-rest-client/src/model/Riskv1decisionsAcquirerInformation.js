...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.Riskv1decisionsAcquirerInformation = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The Riskv1decisionsAcquirerInformation model module.
   * @module model/Riskv1decisionsAcquirerInformation
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Riskv1decisionsAcquirerInformation</code>.
   * @alias module:model/Riskv1decisionsAcquirerInformation
   * @class
   */
  ...
  /**
   * Constructs a <code>Riskv1decisionsAcquirerInformation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Riskv1decisionsAcquirerInformation} obj Optional instance to populate.
   * @return {module:model/Riskv1decisionsAcquirerInformation} The populated <code>Riskv1decisionsAcquirerInformation</code> instance.
   */

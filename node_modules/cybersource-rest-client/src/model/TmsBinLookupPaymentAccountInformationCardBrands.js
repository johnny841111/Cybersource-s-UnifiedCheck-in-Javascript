...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CyberSource.TmsBinLookupPaymentAccountInformationCardBrands = factory(root.CyberSource.ApiClient);
  }
  ...
  /**
   * The TmsBinLookupPaymentAccountInformationCardBrands model module.
   * @module model/TmsBinLookupPaymentAccountInformationCardBrands
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>TmsBinLookupPaymentAccountInformationCardBrands</code>.
   * @alias module:model/TmsBinLookupPaymentAccountInformationCardBrands
   * @class
   */
  ...
  /**
   * Constructs a <code>TmsBinLookupPaymentAccountInformationCardBrands</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TmsBinLookupPaymentAccountInformationCardBrands} obj Optional instance to populate.
   * @return {module:model/TmsBinLookupPaymentAccountInformationCardBrands} The populated <code>TmsBinLookupPaymentAccountInformationCardBrands</code> instance.
   */

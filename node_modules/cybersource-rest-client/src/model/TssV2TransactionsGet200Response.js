...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('recurringPaymentInformation')) {
        obj['recurringPaymentInformation'] = TssV2TransactionsGet200ResponseRecurringPaymentInformation.constructFromObject(data['recurringPaymentInformation']);
      }
  ...
  /**
   * @member {module:model/TssV2TransactionsGet200ResponseRecurringPaymentInformation} recurringPaymentInformation
   */

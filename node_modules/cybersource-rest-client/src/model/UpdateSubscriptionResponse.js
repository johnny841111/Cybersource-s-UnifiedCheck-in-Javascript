...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateSubscriptionResponseSubscriptionInformation', 'model/GetAllSubscriptionsResponseLinks'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CreateSubscriptionResponseSubscriptionInformation'), require('./GetAllSubscriptionsResponseLinks'));
  } else {
    // Browser globals (root is window)
    if (!root.CyberSource) {
      root.CyberSource = {};
    }
    root.CyberSource.UpdateSubscriptionResponse = factory(root.CyberSource.ApiClient, root.CyberSource.CreateSubscriptionResponseSubscriptionInformation, root.CyberSource.GetAllSubscriptionsResponseLinks);
  }
}(this, function(ApiClient, CreateSubscriptionResponseSubscriptionInformation, GetAllSubscriptionsResponseLinks) {
  'use strict';
